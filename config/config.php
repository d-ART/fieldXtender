...
array_insert($GLOBALS['BE_MOD']['devtools'], 4,
	array(
		'fieldXtender' => array(
			'icon'			=> 'system/modules/fieldXtender/assets/icon.png',
			'tables'		=> array('tl_fieldXtender','tl_fieldXtender_fields'),
			'stylesheet' 	=> 'system/modules/fieldXtender/assets/style.css',
			'sync'			=>	array('fieldXtender', 'generateField'),
			'generateAlias' => array('fieldXtender_fields','generateAlias')
		)
	)
);
